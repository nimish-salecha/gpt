...
class Header extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      width: dwidth,
      child: Container(   //removed column -> children wigit from the container as now we have 1header only
        height: kToolbarHeight * 0.9,//dheight * 0.1,
        color: const Color.fromARGB(255, 10, 75, 129),
        padding:  EdgeInsets.fromLTRB(dwidth*0.01, 8, dwidth*0.025, 8),
        child: Row(
...
////////-------------------old code(font size(increased) error)-------------------
// // ignore_for_file: prefer_const_constructors
...
//                           child:  Text(
//                             'Tour',
//                             style: TextStyle(color: Colors.white, fontSize: dwidth*0.05 /*decoration: TextDecoration.underline*/),
//                           ),
//                         ),
